                    ...
                    <div className="flex gap-3 py-4">
                        ...
                        <span className='w-96'>
                            ...
                            <p className='text-sm md:text-md leading-tight'>
                                ...
                                Quam doloremque eligendi voluptate iste rem tenetur
                                numquam nam nihil, earum excepturi dolores iure
                                sunt possimus sequi sed cumque mollitia ipsum debitis.
                            </p>
                        </span>
                    </div>
