        ...
        <div className="text-white flex w-full justify-between items-start p-10 md:p-20">
            <div className="md:w-2/4 md:pt-10">
                ...
                <p className="text-sm md:text-xl tracking-tight mt-6 text-justify">
                    IT Systems Engineer with 5+ years of experience in IT
                    infrastructure management, automation, and software
                    development. Proven expertise in deploying camera systems,
                    developing Python-based automation solutions, and managing
                    cross-functional technology projects. Adept at using tools
                    like PyQt, OpenCV, and Camera SDKs to deliver practical,
                    real-world solutions that enhance operations and user
                    experience.
                </p>
                <a href="#Contact">
                ...
                <a
                    href={`${import.meta.env.BASE_URL}SelvababuArikaran.pdf`}
                    download
                >
                    <button
